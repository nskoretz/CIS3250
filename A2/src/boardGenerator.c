...
* @version CIS*3250 Refactoring Lab Assignment 2
*
**/

/*********Changes made Andrew Cheung******************
-changed all variable names with _ to camel case and struct names to PascalCase
-variables all declared at the top of the block
-changed convention for if-else statement
-added header comments to all functions and the top
